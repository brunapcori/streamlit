...
st.sidebar.title("Navegação em sidebar")
...
with st.expander("📝 1. TEXTOS E TIPOGRAFIA (Clique para abrir)", expanded=True):
    ...
    st.markdown("**Texto em Negrito** feito com st.markdown() dois asteriscos")
    st.markdown("*Texto em Itálico* feito com st.markdown() um asterisco")
